      ...
      <div className={ContainerClass}>
        ...
        <div className="row desktop-reverse">
          <div data-aos="fade-right" className={ColClass}>
            <img src={`${imageBaseSrc}/oferta/malarz-wykonczenia.jpg`} />
          </div>
          <div data-aos="fade-left" className={ColClass}>
            <h6>Szeroka gama prac:</h6>
            Instalatorskich oraz innych usług remontowo-budowlanych pozwala nam
            z surowych ścian i posadzek uczynić wnętrza kompletne, gotowe do
            natychmiastowego wprowadzenia przez lokatorów. Współpracujemy
            zarówno z inwestorami indywidualnymi, jak i deweloperami oraz
            firmami z branży budowlanej. Chętnie podejmujemy się prac
            wykończeniowych pod klucz jako podwykonawca.
          </div>
        </div>
        <div className="row">
          <div className={ColClass}>
